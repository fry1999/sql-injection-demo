	...
	<div id="main">
		...
		<div id="content">
			...
			<div class="left-1">
				<img
					src="sanpham/<%=
					productDAO.getProduct(ma_san_pham)
					.getHinh_anh()%>"
				...
				<table>
					<tr class="row1">
						<td class="col2" colspan="2"
							style="padding: 10px; color: blue; font-size: 15px; text-transform: uppercase; text-align: center; font-weight: bold"><%=productDAO.getProduct(ma_san_pham)
					.getTen_san_pham()%></td>
					</tr>
					<tr class="row2">
						<td class="col1">Hãng sản xuất:</td>
						<td class="col2"><%=productDAO.getProduct(ma_san_pham)
					.getHang_san_xuat()%></td>
					</tr>

					<%-- <tr class="row2">
						<td class="col1">Giá bán:</td>
						<td class="col2"><%=nf.format(productDAO.getProduct(ma_san_pham)
					.getGia_ban()) %> VNĐ</td> --%>
					</tr>
